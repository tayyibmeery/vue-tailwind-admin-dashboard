          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              <div class="mb-5 sm:mb-8">
                <h1 class="mb-2 font-semibold text-gray-800 text-title-sm dark:text-white/90 sm:text-title-md">Sign In
                </h1>
                  ...
                  <div class="flex items-center justify-between">
                    <div>
                      <label for="keepLoggedIn"
                        ...
                        <div class="relative">
                          <input type="checkbox" id="keepLoggedIn" class="sr-only" />
                          <div
                            class="mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] border-gray-300 dark:border-gray-700 bg-transparent">
                          </div>
                        </div>
                        Keep me logged in
                      </label>
