      ...
      <form @submit.prevent="submitForm">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div class="space-y-4">
            ...
            <!-- Date Dispatched -->
            <div>
              <label class="block text-sm font-medium">Date Dispatched</label>
              <div class="relative">
                <input :ref="el => { if (el) datePickerRefs.date_dispatched = el }" v-model="form.date_dispatched"
...
function initDatePickers() {
  const dateFields = ['date_dispatched', 'date_departed', 'date_reached']
